...
|---|---|---|
| **Supabase** (PostgreSQL + Auth + Storage, región São Paulo `sa-east-1`) | Aliados, credenciales, puntos, niveles, racha, módulos, eventos, canjes y **copia de trabajo** de las empresas referidas y su avance | Fuente de verdad del programa de puntos |
...
- Datos alojados en Supabase São Paulo, que implica transferencia internacional; se declara en la política.
